...
if __name__ == "__main__":
	...
	# test.parse_comment('582259981056')ls
	# headers = test.get_headers()
	# print(headers)
	# test.get_cookies2('566848769176')
	# test.save_to_file()
	test.download_dell_TMall()
	# test.testD()
